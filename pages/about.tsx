import { Box, Stack, VStack, Heading, Flex, Text, Image, useColorMode } from '@chakra-ui/react';
        ...
        <Flex justifyContent="space-between">
          <Flex>
            ...
            <Stack spacing={2} pl={3} align="left">
              <Heading alignSelf="start" fontSize="xl" color={`mode.${colorMode}.career.text`}>
                {role}
              </Heading>
              <Heading alignSelf="start" fontSize="sm" color={`mode.${colorMode}.career.subtext`}>
                <i>{title}</i>
              </Heading>
              <Stack
                spacing={1}
